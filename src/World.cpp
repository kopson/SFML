...
void World::loadTextures()
{
	...
	mTextures.load(Textures::HealthRefill, "res/textures/HealthRefill.png");
	mTextures.load(Textures::MissileRefill, "res/textures/MissileRefill.png");
	mTextures.load(Textures::FireSpread, "res/textures/FireSpread.png");
	mTextures.load(Textures::FireRate, "res/textures/FireRate.png");
}
